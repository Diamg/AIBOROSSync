...
\fancyfoot{}
\fancyfoot[RO,LE]{\includegraphics[scale=0.3]{images/etseib.jpg}}
...
\subsection{Moviment d'una articulació de forma sinusoïdal usant liburbi per C++}
\subsection{Moviment d'una articulació de forma sinusoïdal usant una conecció telnet i python}
\end{document}
