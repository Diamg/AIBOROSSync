...
\item Archivos .ocf: Definen el comportamiento en cuanto a tiempos de ejecución, memoria y prioridad de ejecución.
...
En cuanto a recepción de datos se refiere es mas rápido usando liburbi aunque sufre las mismas congelaciones que usando python y a efectos prácticos para la implementación del paquete es lo mismo que transmita a 10kHz que a 20kHz. Y respecto al envió el seguimiento de la trayectoria es parecido en ambos metodos, python y liburbi con dos clientes, y el retraso del seguimiento parece menor con el segundo. 

Finalmente se elige usar la librería liburbi dado que parece ser superior en los criterios evaluados. Por otra parte se ha tenido en consideración que el paquete será más complejo que los experimentos y puede ser útil que la velocidad de ejecución de un programa en C++ sea mayor que en python.
...
En las Figuras \ref{fig:resumimic} y \ref{fig:resumimic2} se puede observar como reacciona las articulaciones de ambos AIBOs al mover manualmente uno de ellos. 
%MASGRAFICOs
\begin{figure}[H]
	\centering
    \includegraphics[scale=0.26]{images/retmin2.jpg}
	 \caption{Posiciones de las articulaciones de dos AIBO.}
  \label{fig:resumimic}
\end{figure}
\begin{figure}[H]
	\centering
    \includegraphics[scale=0.26]{images/malo5hz.jpg}
	 \caption{Posiciones de las articulaciones de dos AIBO y el tópico de comunicación.}
